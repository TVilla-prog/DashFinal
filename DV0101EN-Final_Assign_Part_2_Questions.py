...
# Plot 2 Total Monthly Automobile sales using a line chart.
    ...
    # Plot 4 Total Advertisement Expenditure for each vehicle using a pie chart
        ...
        Y_chart4 = dcc.Graph(figure=px.pie(exp_data, values='Advertising_Expenditure', names='Vehicle_Type', title='Total Advertisement Expenditure for each Vehicle in the year {}'.format(input_year)))
